...
class Chromatine:
    def __init__(self, histones_count):
        ...
        self.histones = np.random.choice(['A', 'B', 'C','D'], histones_count)
        ...
        if 1 <= position < len(self.histones) - 1:
            ...
            if nth_position < len(self.histones):
                ...
                if current_histone == 'A' and nth_histone == 'B':
                    ...
                    enzyme_changes += 1 
                elif current_histone == 'A' and nth_histone == 'D':
                    ...
                    self.histones[nth_position] = 'B'
                    enzyme_changes += 1 
                elif current_histone == 'B' and nth_histone == 'D':
                    self.histones[nth_position] = 'C'
                    enzyme_changes += 1 
                    ...
                    self.histones[nth_position] = 'C'
                    enzyme_changes += 1
                elif current_histone == 'C' and nth_histone == 'D':
                    self.histones[nth_position] = 'C'
                    enzyme_changes += 1
                elif current_histone == 'D' and nth_histone == 'A':
                    self.histones[nth_position] = 'B'
                    enzyme_changes += 1
                elif current_histone == 'D' and nth_histone == 'B':
                    self.histones[nth_position] = 'C'
                    enzyme_changes += 1
                elif current_histone == 'D' and nth_histone == 'C':
                    self.histones[nth_position] = 'D'
                    enzyme_changes += 1
...
csv_filename = f'{current_directory}4statesModel.csv'
